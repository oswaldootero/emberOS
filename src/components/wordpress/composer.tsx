...
export function WPComposer() {
    ...
    return (
      <Card className="text-center">
        <CardHeader>
          ...
          <CardTitle>{status === "publish" ? "Published" : status === "future" ? "Scheduled" : "Saved as draft"}</CardTitle>
          <CardDescription>
            {status === "publish"
  ...
  return (
    <form onSubmit={handleSubmit} className="grid lg:grid-cols-[1.6fr_1fr] gap-6">
      <Card className="lg:order-1">
        <CardHeader>
          ...
          <CardDescription>
            Write in Markdown — it'll be converted to HTML on publish.
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-2">
            ...
            <Tabs defaultValue="write">
              ...
              <TabsContent value="preview">
                <div className="min-h-[420px] rounded-lg border border-white/[0.05] bg-ink-900/60 p-4 prose-preview">
                  {body ? (
